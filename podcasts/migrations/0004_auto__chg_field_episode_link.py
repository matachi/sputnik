...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Episode.link'
        db.alter_column('podcasts_episode', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'podcasts.category': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'child_category'", 'blank': 'True', 'null': 'True', 'to': "orm['podcasts.Category']"}),
        ...
        'podcasts.episode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'blank': 'True', 'max_length': '300'}),
            'podcast': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'episodes'", 'to': "orm['podcasts.Podcast']"}),
            'published': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'podcasts.podcast': {
            'Meta': {'object_name': 'Podcast'},
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'podcasts'", 'blank': 'True', 'to': "orm['podcasts.Category']", 'symmetrical': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'podcasts'", 'blank': 'True', 'to': "orm['podcasts.Tag']", 'symmetrical': 'False'}),
        ...
        'podcasts.podcastuserprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'listened_to': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'listeners'", 'blank': 'True', 'to': "orm['podcasts.Episode']", 'symmetrical': 'False'}),
            'subscribed_to': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'subscribers'", 'blank': 'True', 'to': "orm['podcasts.Podcast']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'podcasts_profile'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        'podcasts.tag': {
